# menor_maior_tempertura_teste_minima_Exemplo_da aula
...
def testa_minina():
    ...
    teste_pontual([30, 27, 25, 26, 29, 31, 32, 33, 30, 29, 24, 26, 30, 27, 24, 25, 26, 24, 22, 23, 25, 28, 28, 32, 32, 31, 29, 28, 31, 33], 22)
